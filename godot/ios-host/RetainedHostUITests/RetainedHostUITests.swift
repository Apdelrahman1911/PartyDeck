...
final class RetainedHostUITests: XCTestCase {
    ...
    private func assertDormant(_ value: [String: Any]) throws {
        ...
        XCTAssertNotNil(native["authorityForegroundGrant"])
        XCTAssertFalse(flag("authorityForegroundGrant", native))
        XCTAssertNotNil(native["authorityReadyConfirmed"])
        XCTAssertFalse(flag("authorityReadyConfirmed", native))
