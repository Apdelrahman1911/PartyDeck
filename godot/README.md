...
apps. Standard table remains the initial gameplay surface. Android and iOS
shipping profiles also expose both real Godot styles. Explicit qualification
profiles retain their separate runtime checks.
Follow the
