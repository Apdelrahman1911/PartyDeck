...
freeze_path = BASE / 'expected-native-freeze-v5.json'
freeze = read(freeze_path)
check('supplied native freeze v5 identity', digest(freeze_path) == '4e6f2f910e20ff7a70ae1d4eeb182f61cb5774c0c936336d36df4fac045f6659')
...
summary = {
    ...
    'optionalStartupMousePatchIncluded': False, 'threeDDemandOptimizationExpected': False,
