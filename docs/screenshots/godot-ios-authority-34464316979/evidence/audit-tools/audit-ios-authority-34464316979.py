...
old = read(Path('/tmp/partydeck-engine-ci/34460468965/authority-package-evidence-summary.json'))
...
package_summary = {'auditUsesExactRunSource': True, 'runId': int(run), 'headSha': head, 'scope': 'Actual linked Simulator app identity; runtime qualification is separate.',
    ...
    'comparisonWithPreviousAuthorityRun': {'runId': 34460468965, 'previousPackageSummarySha256': digest(Path('/tmp/partydeck-engine-ci/34460468965/authority-package-evidence-summary.json')),
