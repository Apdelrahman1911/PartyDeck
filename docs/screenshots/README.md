...
These are actual Godot-rendered images. Iteration 01 uses synthetic structural data; iteration 02 uses frozen projections generated by the real Kotlin authority. Both are static renderer checks and do not establish authority-accepted gameplay or native mobile accessibility. Originals from every supplied iteration are retained.
